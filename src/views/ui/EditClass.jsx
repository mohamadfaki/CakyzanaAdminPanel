...
const EditClass = () => {
    ...
    useEffect(() => {
        if (classCategoryID && titleID) {
            db.collection("classCategory").doc(classCategoryID).collection("items").doc(titleID).get()
                .then((doc) => {
                    if (doc.exists) {
                        const data = doc.data();
        ...
        <div>
            ...
            <Form onSubmit={handleSubmit}>
                <FormGroup>
                    ...
                    <Input type="text" name="classCategoryID" id="classCategoryID" value={classCategoryID} required readOnly />
                </FormGroup>
                <FormGroup>
                    <Label for="classCategory">Class Category</Label>
                    <Input type="text" name="classCategory" id="classCategory" value={classCategory} onChange={(e) => setClassCategory(e.target.value)} required />
                </FormGroup>
                <FormGroup>
                    <Label for="titleID">Title ID</Label>
                    <Input type="text" name="titleID" id="titleID" value={titleID} required readOnly/>
                </FormGroup>
                <FormGroup>
                ...
                <FormGroup>
                    ...
                    <Input type="textarea" name="description" id="description" value={description} onChange={(e) => setDescription(e.target.value)} required />
                </FormGroup>
                <Button type="submit" color="primary">Submit</Button>
                <Button style={{float:'right'}} color="secondary" onClick={()=>navigate('/classesManagement')}>Back</Button>
            </Form>
        </div>
    )
};
